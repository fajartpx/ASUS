...
export default class AddRelationForm extends Component {
  _scrollY = new Animated.Value(0)
  render() {
    const { dimensions, isAddRelationVisible, genderValue } = this.state
            ...
            >
              ...
              <View style={{ backgroundColor: Color.white, padding: 15, borderRadius: 8, marginHorizontal: 20, marginVertical: 20, marginTop: StatusBar.currentHeight + 20, elevation: 10 }}>
                <View style={{ borderBottomColor: Color.borderColor, borderBottomWidth: 1, paddingBottom: 15, marginBottom: 20, flexDirection: 'row', alignItems: 'center' }}>
                  <View style={{ flex: 1 }}>
                    <Text style={{ fontWeight: 'bold' }}>Tambah Relasi</Text>
                    <Text style={{ fontSize: 13, color: Color.textMuted }}>Silakan lengkapi data relasi Anda</Text>
                  </View>
                  <TouchableOpacity
                ...
                <Input
                  ...
                  inputableStyle={{ backgroundColor: Color.grayLighter, borderWidth: 0 }}
                />
                ...
                ]} placeholder='Status Dalam Keluarga' selectionStyle={{ backgroundColor: Color.grayLighter, borderWidth: 0 }} />
